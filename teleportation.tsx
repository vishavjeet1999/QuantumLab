  ...
  return (
    ...
    <ScrollView style={{ padding: 50, flex:1 }}>
      ...
      {/* <View style={{ marginVertical: 10 }}>
       ...
       <View style={{ marginVertical: 10 }}>
        <Text style={{ fontSize: 16, marginBottom: 8 }}>Teleportation:</Text>
        <Text>a000 = {state.a000.re.toFixed(2)} + {state.a000.im.toFixed(2)}i</Text>
        <Text>a001 = {state.a001.re.toFixed(2)} + {state.a001.im.toFixed(2)}i</Text>
        <Text>a010 = {state.a010.re.toFixed(2)} + {state.a010.im.toFixed(2)}i</Text>
        <Text>a011 = {state.a011.re.toFixed(2)} + {state.a011.im.toFixed(2)}i</Text>
        <Text>a100 = {state.a100.re.toFixed(2)} + {state.a100.im.toFixed(2)}i</Text>
        <Text>a101 = {state.a101.re.toFixed(2)} + {state.a101.im.toFixed(2)}i</Text>
        <Text>a110 = {state.a110.re.toFixed(2)} + {state.a110.im.toFixed(2)}i</Text>
        <Text>a111 = {state.a111.re.toFixed(2)} + {state.a111.im.toFixed(2)}i</Text>
      </View>
      ...
      {/* <View style={{ marginVertical: 10 }}>
        <Text>Teleportation Simulator</Text>
